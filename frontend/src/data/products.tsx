...
export const PRODUCTS: Product[] = [
  ...
  { id: 'p17', nome: 'Óleo de Barba', linha: 'Wood', cap: 30, preco: 45.0, preco5: 42.75, preco10: 40.5, precoSugestao: 70.0, estoque: 0 },
...
export const PRODUTOS_BANCADA: Product[] = [
  ...
  { id: 'b16', nome: 'Óleo de Barba', linha: 'Wood', cap: 30, preco: 37.0, estoque: 0 },
  { id: 'b17', nome: 'Óleo de Barba', linha: 'Ocean', cap: 30, preco: 37.0, estoque: 0 },
