...
const CATALOG_ORDER_RULES: Array<{ rank: number; patterns: string[] }> = [
  ...
  { rank: 5, patterns: ['oleo de barba', 'óleo de barba', 'oleo'] },
  { rank: 6, patterns: ['creme pos barba', 'creme pós barba', 'pos-barba', 'pós-barba'] },
  { rank: 7, patterns: ['pomada efeito teia'] },
  { rank: 8, patterns: ['pomada efeito matte'] },
  { rank: 9, patterns: ['pomada efeito brilho'] },
  { rank: 10, patterns: ['po modelador', 'pó modelador', 'top modelador'] },
